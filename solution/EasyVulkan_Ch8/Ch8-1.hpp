...
int main() {
	...
	while (!glfwWindowShouldClose(pWindow)) {
		...
		vkCmdPushConstants(commandBuffer, pipelineLayout_screen, VK_SHADER_STAGE_VERTEX_BIT, 0, 8, &windowSize);//TODO Handle Intel Integrated GPU
		...
		vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS,
			pipelineLayout_screen, 0, 1, descriptorSet_texture.Address(), 0, nullptr);
